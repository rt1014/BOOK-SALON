...
<body>
    ...
    <nav>
        ...
        <a href="main/boy_view.php"><label class="boy">少年漫画</label></a>
        <a href="main/youth_view.php"><label class="young">青年漫画</label></a>
        <a href="main/girl_view.php"><label class="girl">少女漫画</label></a>
        <a href="main/novel_view.php"><label class="novel">小説</label></a>
        <a href="main/utility_view.php"><label class="utility">実用書</label></a>
        <a href="main/photo_view.php"><label class="photo">写真集</label></a>
    </nav>
    <article>
            <section>
                <ul class="type_TOP">
